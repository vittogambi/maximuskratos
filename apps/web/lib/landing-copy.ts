...
export const LANDING_PROBLEM = {
  ...
  lead: 'No estás destruido. Estás fragmentado.',
  points: [
    'Tienes fuerza, pero no dirección.',
    'Tienes responsabilidades, pero no visión.',
    'Tienes deseos de cambiar, pero no un sistema.',
    'Tienes potencial, pero lo dispersas entre urgencias, hábitos, deuda, cansancio, culpa, aislamiento o falta de propósito.',
  ] as const,
  close:
    'Esa fragmentación no se queda en la teoría: se manifiesta en tu mentalidad, tus relaciones, tus finanzas y tu cuerpo. MK nace para quien sabe que puede ser más, y necesita ordenar su vida desde la raíz.',
} as const;
...
export const LANDING_PROFILES = [
  {
    num: '01',
    title: 'En crisis',
    body: 'Sabes que algo no está bien. Estás cansado, disperso, endeudado, solo o desconectado de ti mismo. Necesitas detener la caída y recuperar control.',
  },
  {
    num: '02',
    title: 'Inestable',
    body: 'Tienes momentos de avance, pero no sostienes el proceso. Empiezas, abandonas, vuelves a intentar. Necesitas disciplina, método y continuidad.',
  },
  {
    num: '03',
    title: 'Sólido',
    body: 'Funcionas. Trabajas. Cumples. Entrenas o produces. Pero sientes que tu vida todavía no está alineada con una misión mayor. Necesitas profundidad, propósito e impacto.',
  },
  {
    num: '04',
    title: 'Constructor',
    body: 'Ya tienes base, pero quieres llevar tu vida a otro nivel: ordenar cuerpo, mente, finanzas, relaciones y legado para servir mejor y construir algo que permanezca.',
  },
] as const;

export const LANDING_PROFILES_CLOSE =
  'MK no es solo para quien está roto. Es para quien quiere reconstruirse, fortalecerse y orientarse hacia una vida más grande que sí mismo.';
...
export const LANDING_REALMS: ReadonlyArray<{
...
}> = [
  {
    ...
    body: 'Identidad, principios, propósito, visión y estándares. Entrega dirección a tu sistema de vida.',
  },
  {
    label: 'Mente',
    icon: 'brain',
    ...
    body: 'Interpretación, estrategia, regulación y construcción de hábitos. Entrega estructura.',
  },
  {
    label: 'Cuerpo',
    icon: 'muscles',
    ...
    body: 'Presencia, ejecución, entrenamiento, descanso y nutrición. Entrega capacidad y acción.',
  },
];

export const LANDING_REALMS_CLOSE =
  'Cuando espíritu, mente y cuerpo se alinean, dejas de reaccionar a la vida y empiezas a construirla.';
...
export const LANDING_DOMAINS_SECTION = {
  ...
  leadInternalLabel: 'Capacidades internas',
  leadInternalItems: ['Espíritu', 'Mente', 'Cuerpo'] as const,
  leadExternalLabel: 'Territorios de la vida',
  leadExternalItems: ['Mentalidad', 'Relaciones', 'Finanzas', 'Salud física'] as const,
  leadClose:
    'Los pilares son las capacidades con las que vives. Los ámbitos son los territorios donde vives.',
...
export const LANDING_WHAT_IS = {
  ...
  lead: 'Tres dimensiones. Un sistema. Cuando se alinean, dejas de reaccionar a la vida y empiezas a construirla.',
} as const;
...
export const LANDING_BENEFITS: ReadonlyArray<{
  ...
  },
  {
    title: 'Coherencia',
    icon: 'anchor',
    body: 'Tus hábitos, planes y prioridades empiezan a alinearse con quien dices querer ser.',
  },
  {
    title: 'Orden',
    icon: 'target',
...
export const LANDING_CLOSE = isEarlyAccessMode()
  ? ({
      ...
      titleLine2: 'Se trata de convertirte en alguien capaz de sostener lo que dices valorar.',
      body: 'MAXIMUS KRATOS no promete una vida fácil. Promete un camino ordenado para hacerte responsable de tu espíritu, tu mente, tu cuerpo y tu impacto.',
